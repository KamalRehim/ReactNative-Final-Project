...
const Search=()=>{
    ...
    return(
        <ScrollView contentContainerStyle={{backgroundColor:"black",flex:1}}>
            <TextInput placeholderTextColor="#FFFFFF" placeholder={t("searchquery")} className="bg-[#353236] mx-5 mt-8 rounded-[5px] px-3 py-4 text-white text-lg" onChangeText={(text)=>{
                setSearchTerm(text);
            }}/>
            {
                searchTerm&&
